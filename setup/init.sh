...
curl -X GET -L https://github.com/kubernetes-sigs/aws-iam-authenticator/releases/download/v0.7.16/aws-iam-authenticator_0.7.16_darwin_arm64 -o aws-iam-authenticator
